...
export default function HospitalityTemplate({
  ...
  return (
    <div className="bg-[#fdfaf6] text-stone-900">
      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-28 md:py-40 text-center text-white">
          ...
          <a
            href={telHref(content.phone)}
            className="inline-block mt-10 px-10 py-4 text-sm uppercase tracking-[0.2em] font-medium"
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 py-20">
        <div className="w-16 h-px mx-auto mb-12" style={{ backgroundColor: accent }} />
      ...
      {content.about && (
        <section className="bg-stone-900 text-stone-100">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 py-20 text-center">
            ...
            <p className="text-lg leading-relaxed opacity-90">{content.about}</p>
          </div>
        </section>
      )}
