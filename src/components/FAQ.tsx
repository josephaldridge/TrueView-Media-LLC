...
export const homepageFAQs: FAQItem[] = [
  {
    ...
    answer:
      "Most professionally built websites cost $2,500–$5,000 or more. We believe small businesses and entrepreneurs should have access to a fast, professional website without paying agency prices. That's why we offer a one-time flat build fee of $1,000. Ask about our military discount.",
  },
  {
  ...
  },
  {
    ...
    answer:
      'One single payment of $1,000 upfront to start your project—that covers the entire build through launch. After that, the only thing you would ever pay for is an edit request at $49, and only if you ask for one. For larger custom projects, payment terms are discussed before any work begins.',
  },
];
